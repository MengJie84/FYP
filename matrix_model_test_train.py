...
print(f"Test Set Accuracy: {xgb_test_accuracy}")
print(f"Mean CV Accuracy: {np.mean(xgb_cv_scores)}")
print(f"10-Fold Cross-Validation Accuracy Scores: {xgb_cv_scores}")
...
print(f"Mean CV Accuracy: {np.mean(rf_cv_scores)}")
print(f"10-Fold Cross-Validation Accuracy Scores: {rf_cv_scores}")
