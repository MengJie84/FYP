...
# Evaluate XGBoost
print('--------------------XGBoost------------------------')
evaluate_model('XGBoost', xgb.XGBClassifier(use_label_encoder=False, eval_metric='logloss'), X, y, kf)


# Evaluate Random Forest
print('\n---------------Ensemble Random Forest----------------------------')
evaluate_model('Random Forest', RandomForestClassifier(random_state=24), X, y, kf)

print('\n---------------Logistic Regression----------------------------')
logistic_model = LogisticRegression(solver='liblinear', random_state=42)
evaluate_model('Logistic Regression', logistic_model, X, y, kf)

print('\n---------------Decision Tree----------------------------')
tree_model = DecisionTreeClassifier(random_state=42)
evaluate_model('Decision Tree', tree_model, X, y, kf)

print('\n---------------Naive Bayes----------------------------')
nb_model = GaussianNB()
evaluate_model('Naive Bayes', nb_model, X, y, kf)

print('\n---------------K-NN----------------------------')
knn_model = KNeighborsClassifier()
evaluate_model('k-NN', knn_model, X, y, kf)
