...
plot_matrix(df_balanced, 'Matrix After Balancing')

# Preparing data for model training
X_balanced = df_balanced[['Prediction']].values # Features from balanced DataFrame
y_balanced = df_balanced['Actual'].values  # Target from balanced DataFrame
...
# If your task is binary classification, and you're using 'sigmoid' activation in the last layer,
# ensure 'y' is not one-hot encoded.
# If it's multiclass classification with 'softmax', use:
# y = to_categorical(df['Actual'].values)
